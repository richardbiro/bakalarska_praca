...
Zameriame sa aj na špecifické parametrické vzorce, ktoré generujú magické štvorce veľkosti $3 \times 3$ s aspoň $6$ druhými mocninami kladných celých čisel. V roku $2019$ objavil Arkadiusz Wesolowski  nasledovný vzorec pre $n \in \mathbb{N}, w = 6n^2 + 6n + 2, x = 2n + 1, y = 3n^2 + 2n, z = 3n^2 + 4n + 1$ \cite{multimagie}:
...
V júni 2010 našiel Michael Quist nasledovný magický štvorec, ktorý má iba jeden zlý bimagický súčet \cite{multimagie}:
...
Bimagické štvorce veľkosti väčšej ako $5 \times 5$ sú už dobre známe. Georges Pfeffermann dokonca našiel v roku 1890 superbimagický štvorec veľkosti $8 \times 8$. Použil v ňom všetky čísla z množiny $\{1, 2, ... , 64\}$ \cite{multimagie}: \\
...
V roku 2007 našiel Lee Morgenstern nasledovný štvorec s jediným súčtom, ktorý nie je multiplikatívny magický \cite{multimagie}:
...
\begin{definition} Nech $n \in \mathbb{N^+}$. Nech $S$ je magický alebo multiplikatívny štvorec veľkosti $n \times n$ a $v_1, ... , v_n$ sú jeho disjunktné vzorky. Potom nazývame skupinu $v_1, ... , v_n$ \textbf{štvorcovou vzorkou}.
\end{definition}
